...
def create_product_variants():
    ...
    for product in products:
        ...
        if selected_product:
            ...
            product_variant = ProductVariant.objects.create(product=product, quantity=quantity, price=price, color=color,
                                                    **selected_product)
            for image in images:
                Content.objects.create(product_variant=product_variant, content=image)
        else:
            ProductVariant.objects.create(product=product, quantity=quantity, price=price, color=color)
